...
$(document).on("click","input[id='next_btn1']", function(){

		var vals = $('[name="studentname"]').val();
		if (!vals)	{
			  alert('Error exists');
			  $('[name="studentname"]').attr('style', "border-radius: 5px; border:#FF0000 1px solid;");
			  $('[name="studentname"]').attr("placeholder", "This field is Mandatory").val("").focus().blur();
		}else{
